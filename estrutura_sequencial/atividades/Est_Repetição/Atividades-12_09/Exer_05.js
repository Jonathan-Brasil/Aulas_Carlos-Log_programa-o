...
//Variáveis
let 
//Número de operários e peças 
num_op,
pecas_op, 

//Número de contas masculinos e femininas 
cont_m = 0, 
cont_f = 0, 

//A média de peças fabricadas pelo sexo masculino e feminina 
media_m = 0, 
media_f = 0, 

// O maior salário e o salário individual de cada operário
salario_maior, 
salario_op,

//Total de folha de pagamento e peças fabricadas 
tot_folha = 0,
tot_pecas = 0,
...
//    do{
        num_op = +prompt("Digite o número do " + cont + "º operário") //+prompt = transforma a string em um valor númerico
